...
public class Car {
	...
	public static void main(String[] args) {
		...
		new Automobile("Ford", 6000, 200), new Automobile("Opel", 5000, 90),
				new Automobile("Mercedes", 100000, 500),
				new Automobile("Suzuki", 3200, 60),
				new Automobile("BMW", 9500, 250), new Suv("Jeep", 12500, true),
				new Suv("Lada", 14600, true), new Suv("Mercedes", 36800, true),
				new Suv("BMW", 25000, false), new Suv("Nissan", 60000, false), };
	...
	private static void sortByPrice(Car[] carsArray) {
		...
		for (int sort = 0; sort < carsArray.length; sort++) {
			...
			System.out
					.println("Cars sorted by price: " + carsArray[sort].price);
