public class Doctor extends Employee {
	...
	public Doctor(int nightMonthDuties, int dayMonthDuties, int monthHours,
			int salary) {
	...
	public void sayDuties() {
		...
		System.out.printf("My night duties per month are: "
				+ this.getNightMonthDuties(nightMonthDuties) + "\n");
		System.out.printf("My day duties per month are: "
				+ this.getDayMonthDuties(dayMonthDuties) + "\n");
	}
}
