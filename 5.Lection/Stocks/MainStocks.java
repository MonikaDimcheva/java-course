...
public class MainStocks {
	public static void main(String[] args) {
		...
		System.out.println("****Stocks****");System.out.println();
		System.out.println("1.Meat\nName: "+pork.getName()+"\nIs it in stock?: "+pork.isInStock
				+"\nIs it row?: "+pork.isRow()+"\nPrice: "+pork.price);
		System.out.println();
		
		System.out.println("2.Vegetables\nName: "+tomato.getName()+"\nIs it in stock?: "+tomato.isInStock
				+"\nHas seeds?: "+tomato.isHasSeeds()+"\nPrice: "+tomato.price);
		System.out.println();
		...
		System.out.println("4.Drinks\nName: "+cocaCola.getName()+"\nIs it in stock?: "+cocaCola.isInStock
				+"\nPrice: "+cocaCola.price+"\nIs it a carbonated drink?: "+cocaCola.isCarbonatedDrink());
		System.out.println();
		System.out.println("5.Desserts\nName: "+cake.getName()+"\nIs it in stock?: "+cake.isInStock
				+"\nDoes it have chocolate flavour?: "+cake.HasChocolateFlavour()+"Price: "+cake.price);
