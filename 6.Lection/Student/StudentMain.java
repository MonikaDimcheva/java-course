...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		nasko.getMarks()
				.put("History", new ArrayList<>(Arrays.asList(4, 4, 6)));
		nasko.getMarks().put("Psychology",
				new ArrayList<>(Arrays.asList(2, 2, 3)));
		nasko.getMarks()
				.put("Biology", new ArrayList<>(Arrays.asList(4, 5, 4)));
		nasko.getMarks().put("Literature",
				new ArrayList<>(Arrays.asList(2, 6, 4)));

		monika.getMarks().put("Art", new ArrayList<>(Arrays.asList(2, 4, 4)));
		monika.getMarks().put("Music", new ArrayList<>(Arrays.asList(6, 6, 6)));
		monika.getMarks()
				.put("Sports", new ArrayList<>(Arrays.asList(4, 2, 5)));
		monika.getMarks().put("Physics",
				new ArrayList<>(Arrays.asList(6, 6, 4)));
		monika.getMarks().put("Computer Science",
				new ArrayList<>(Arrays.asList(6, 5, 6)));

		cecka.getMarks()
				.put("English", new ArrayList<>(Arrays.asList(2, 4, 5)));
		cecka.getMarks().put("Chemistry",
				new ArrayList<>(Arrays.asList(6, 5, 2)));
		cecka.getMarks().put("Economics",
				new ArrayList<>(Arrays.asList(6, 6, 6)));
		cecka.getMarks().put("Geography",
				new ArrayList<>(Arrays.asList(2, 6, 3)));
		cecka.getMarks().put("Public administration",
				new ArrayList<>(Arrays.asList(4, 6, 5)));
