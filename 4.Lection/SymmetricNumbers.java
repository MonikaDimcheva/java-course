...
//Задача:
//Направете програма с функция която принтира всички симетрични 
//числа в интервала [0 ; 999].
		...
		for (int number = 0; number <= 999; number++) {
			if (number < 10) {
				System.out.print(number + ",");
					...
					|| number == 44 || number == 55 || number == 66
					|| number == 77 || number == 88 || number == 99) {
				System.out.print(number + ",");
...
/*
 * public static void printSymmetricNums(){ for (int number=0; number<=999;
 * number++) { if(number<10){ System.out.print(number+","); } else if(number==11
 * || number==22 || number==33 || number==44 || number==44 || number==55 ||
