...
//Задача:
//Направете програма която приема 5 положителни числа от конзолата и 
//намира най-голямото от тях
	...
	public static void main(String[] args) {
		...
		do {
			if (firstNumber < 0 | secondNumber < 0 | thirdNumber < 0
					| forthNumber < 0 | fifthNumber < 0) {

				System.out
						.println("There are negative numbers!\nALL numbers must be positive!!!Try again!\nEnter first number: ");
		...
		while (secondNumber > firstNumber && secondNumber > thirdNumber
		...
		while (forthNumber > firstNumber && forthNumber > secondNumber
				&& forthNumber > thirdNumber && forthNumber > fifthNumber) {
			System.out.println("Forth number is the biggest one!");
			break;
		}
		while (fifthNumber > firstNumber && fifthNumber > secondNumber
				&& fifthNumber > thirdNumber && fifthNumber > forthNumber) {
