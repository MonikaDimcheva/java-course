...
public class SortingNumbers {
	public static void main(String[] args) {
		...
		System.out.println("Numbers are: "+firstNumber+ ","+secondNumber+ ","+thirdNumber+ ","+forthNumber+ ","+fifthNumber);
  ...
  do
    ...
    for(int i=0; i<length; i++ ){
    	System.out.println("Sorted array in ascending order is: "+array[i]);
    }
